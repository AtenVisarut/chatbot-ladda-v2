...
def get_no_data_response(intent_value: str, entities: dict) -> str:
    ...
    elif intent_value == "nutrient_supplement":
        plant = entities.get('plant_type', '')
        if plant:
            return f"จากข้อมูลสินค้า ยังไม่พบสูตรปุ๋ยหรือสินค้าบำรุงสำหรับ{plant}ในระบบค่ะ 🌱\n\nรบกวนบอกเพิ่มหน่อยว่าอยู่ระยะไหนคะ (เช่น รองพื้น, เร่งต้น, แตกกอ, รับรวง) จะได้ค้นหาให้ตรงที่สุดนะคะ"
        else:
            return "จากข้อมูลสินค้า ยังไม่พบข้อมูลที่ตรงกับคำถามค่ะ 🌱\n\nรบกวนบอกเพิ่มหน่อยว่า:\n- เป็นพืชอะไรคะ (เช่น ข้าว, ข้าวโพด, อ้อย)\n- อยู่ระยะไหน (เช่น รองพื้น, เร่งต้น, แตกกอ, รับรวง)\n\nจะได้แนะนำสูตรปุ๋ยที่เหมาะสมค่ะ"
