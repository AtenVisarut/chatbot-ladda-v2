...
class TestClarificationMerge:
    ...
    def test_stage_reply_patterns(self):
        ...
        _STAGE_WORDS = (
            ...
            "ใบแก่", "แตกยอด",
            # Rice / cane / corn / tuber crops — added 2026-04-21
            "แตกกอ", "ตั้งท้อง", "ออกรวง", "สุก", "เก็บเกี่ยว",
            "ก่อนออกดอก", "ติดฝัก", "ฝักแก่", "ออกฝัก",
            "ยืดปล้อง", "สร้างหัว", "ลงหัว", "ให้น้ำยาง",
            "ต้นเล็ก", "เพาะกล้า", "ปลูกใหม่",
        )
        positive = [
            ...
            "ผลอ่อน",
            "ระยะดอก",
            # Rice regression case (Railway log 2026-04-21)
            "แตกกอ", "ออกรวง", "ตั้งท้อง",
        ]
