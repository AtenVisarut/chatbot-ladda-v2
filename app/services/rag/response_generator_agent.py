...
"""
        ...
        if _is_best_pick and context:
            ...
            _CROP_STAGES = {
                ...
                # Vegetables
                "ผัก":          "เพาะกล้า / ต้นอ่อน / โตเต็มที่ / เก็บเกี่ยว",
                "ผักคะน้า":     "เพาะกล้า / ต้นอ่อน / โตเต็มที่ / เก็บเกี่ยว",
                "ผักกาด":       "เพาะกล้า / ต้นอ่อน / โตเต็มที่ / เก็บเกี่ยว",
                "ผักกาดขาว":     "เพาะกล้า / ต้นอ่อน / โตเต็มที่ / เก็บเกี่ยว",
                "คะน้า":        "เพาะกล้า / ต้นอ่อน / โตเต็มที่ / เก็บเกี่ยว",
                "กะหล่ำปลี":     "เพาะกล้า / ต้นอ่อน / โตเต็มที่ / เก็บเกี่ยว",
            ...
            _known_stage_keywords = (
                'ใบอ่อน', 'ใบแก่', 'แตกใบ', 'แตกยอด',
                'ออกดอก', 'ระยะดอก', 'ระยะ',
                'ติดผล', 'ระยะผล', 'ผลอ่อน', 'ผลแก่',
                'ต้นอ่อน', 'ต้นกล้า', 'ต้นเล็ก', 'โตเต็มที่', 'เพาะกล้า',
                'ปลูกใหม่',
                'หลังเก็บเกี่ยว', 'ก่อนเก็บ',
                # Rice
                'แตกกอ', 'ตั้งท้อง', 'ออกรวง', 'สุก', 'เก็บเกี่ยว',
                # Corn / beans
                'ก่อนออกดอก', 'ออกฝัก', 'ติดฝัก', 'ฝักแก่',
                # Cane / cassava / bulbs / rubber
                'ยืดปล้อง', 'สร้างหัว', 'ลงหัว', 'ให้น้ำยาง',
            )
...
→ ถ้ามีหลายตัวที่เหมาะพอกัน → เลือกตัวที่อยู่ลำดับต้นใน "ข้อมูลสินค้าที่ผ่านการตรวจสอบแล้ว" (ระบบจัดเรียงไว้แล้ว)
"""
...
→ **กรณี PGR/สารควบคุมการเจริญเติบโต** (ฟิลด์เป็นประโยคเช่น "ควบคุมการเจริญเติบโตของพืช"
   หรือมี "กลุ่มจิบเบอเรลลิน" / "ยับยั้งการแตกใบอ่อน") → ตอบโดยอธิบายฟังก์ชันนั้น
   เช่น "เป็นสารควบคุมการเจริญเติบโตของพืช กลุ่มจิบเบอเรลลิน" หรือ "PGR ที่ใช้ยับยั้งการแตกใบอ่อน"
   → PGR ไม่มี IRAC/FRAC/HRAC code แต่มีกลไกของตัวเอง — ห้ามตอบว่า "ไม่มีข้อมูล"
"""
