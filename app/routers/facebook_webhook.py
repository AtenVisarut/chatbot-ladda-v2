    ...
    try:
        ...
        if not text:
            ...
            if message.get("attachments"):
                await send_facebook_message(psid, "ขอบคุณค่ะ! ตอนนี้น้องลัดดารองรับข้อความตัวอักษรผ่าน Facebook ค่ะ 📝\nสำหรับวิเคราะห์รูปภาพพืช กรุณาใช้ LINE Official Account นะคะ 🌱")
            return
