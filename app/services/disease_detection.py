...
|--------|------------|----------|----------|----------|
| **ขนาด** | 3-4 มม. | 1-5 มม. | 1-3 มม. | 2-5 มม. |
| **สี** | น้ำตาลอ่อน/เทา | น้ำตาล/ดำ/ขาว | เขียว/เหลือง/ดำ | ขาว+ผงแป้ง |
| **รูปร่าง** | เรียว คล้ายจักจั่น | กลม/รี แบน | อวบกลม นิ่ม | รี มีใยขาว |
| **⭐ท่าเกาะ** | ✅ 45° ก้นชี้ขึ้น! | ติดแน่น ไม่ขยับ | เกาะราบ | เกาะราบ |
| **การเคลื่อนที่** | กระโดด/บินได้ | ❌ อยู่นิ่ง | ช้า/ไม่ค่อยขยับ | ช้ามาก |
| **มีเกราะ/เปลือก** | ❌ ไม่มี | ✅ มีเกราะแข็ง | ❌ ไม่มี | ❌ ไม่มี |
| **พืชที่พบ** | ส้ม มะนาว | ทุกชนิด | ทุกชนิด | ทุกชนิด |
