...
def get_welcome_text() -> str:
    ...
    return (
        "สวัสดีค่ะ ฉันน้องลัดดา ยินดีต้อนรับสู่ ICP Ladda  🌿\n\n"
        "ฉันช่วยวิเคราะห์โรคพืชและแนะนำผลิตภัณฑ์ที่เหมาะสมได้ค่ะ\n\n"
        "วิธีใช้งาน:\n"
...
def get_liff_welcome_text(liff_url: str) -> str:
    """ข้อความต้อนรับพร้อมลิงก์ลงทะเบียน LIFF"""
    return (
        "สวัสดีค่ะ ยินดีต้อนรับสู่ ICP Ladda Chatbot 🌿\n\n"
        ...
        "- จังหวัด\n"
        "- พืชที่ปลูก\n\n"
        "หลังลงทะเบียนแล้ว ส่งรูปพืชที่เป็นโรคมาได้เลยค่ะ!"
    )


def get_registration_required_text(liff_url: str) -> str:
    """ข้อความแจ้งให้ลงทะเบียนก่อนใช้งาน"""
    return (
        "⚠️ กรุณาลงทะเบียนก่อนใช้งานค่ะ\n\n"
        f"ลงทะเบียนที่นี่: {liff_url}\n\n"
        "ข้อมูลที่ต้องกรอก:\n"
        "- ชื่อ-นามสกุล\n"
        "- เบอร์โทรศัพท์\n"
        "- จังหวัด\n"
...
def get_help_menu_text() -> str:
    ...
    return (
        ...
        "━━━━━━━━━━━━━━━\n\n"
        "วิธีใช้งาน:\n"
        "1. ถ่ายรูปพืชที่เป็นโรค\n"
        "2. ส่งรูปมาทางแชท\n"
        "3. ตอบคำถามสั้นๆ (ชนิดพืช, ระยะ)\n"
        "4. รับผลวิเคราะห์และยาแนะนำ\n\n"
        "เคล็ดลับถ่ายรูป:\n"
        "- ถ่ายในที่แสงสว่าง\n"
        "- ถ่ายใกล้ๆ ชัดๆ\n"
        "- เน้นส่วนที่มีอาการ\n\n"
        "คำสั่งอื่นๆ:\n"
        "- พิมพ์ \"ดูสภาพอากาศ\" เพื่อเช็คอากาศ\n"
        "- พิมพ์ \"ดูผลิตภัณฑ์\" เพื่อดูสินค้า\n"
        "- พิมพ์ \"วิธีใช้งาน\" เพื่อดูคู่มือ\n"
        "- พิมพ์ \"ล้างความจำ\" เพื่อเริ่มใหม่\n\n"
        "💬 หรือพิมพ์ถามเรื่องโรคพืชได้เลยค่ะ"
    )
...
def get_usage_guide_text() -> str:
    ...
    return (
        "📖 คู่มือการใช้งาน ICP Ladda Chatbot\n"
        "━━━━━━━━━━━━━━━━━━━━━━━━━━\n\n"
        "📷 ตรวจโรคพืช:\n"
        "- ส่งรูปพืชที่มีอาการมาทางแชท\n"
        "- เลือกชนิดพืชและระยะการเติบโต\n"
        "- รับผลวิเคราะห์พร้อมแนะนำผลิตภัณฑ์\n\n"
        "💡 เคล็ดลับถ่ายรูป:\n"
        "- ถ่ายในที่แสงสว่าง\n"
        "- ถ่ายใกล้ๆ ชัดๆ\n"
        "- เน้นส่วนที่มีอาการ\n\n"
        "🌤️ ดูสภาพอากาศ:\n"
        "- พิมพ์ \"ดูสภาพอากาศ\" แล้วแชร์ตำแหน่ง\n"
        "- รับข้อมูลอุณหภูมิ ความชื้น และคำแนะนำ\n\n"
        "💬 ถามตอบเรื่องโรคพืช:\n"
        "- พิมพ์คำถามเกี่ยวกับโรคพืชได้เลย\n"
        "- ระบบจะค้นหาข้อมูลจากฐานความรู้ให้\n\n"
        "📚 ดูข้อมูลโรคพืชเพิ่มเติมที่:\n"
...
# =============================================================================
# Weather & Crop Risk Messages
# =============================================================================

def get_weather_error_text(error_message: str) -> str:
    """ข้อความ error สภาพอากาศ"""
    return (
        f"❌ เกิดข้อผิดพลาด\n\n"
        f"{error_message}\n\n"
...
def get_crop_selection_text() -> str:
    """ข้อความให้เลือกพืชเพื่อวิเคราะห์ความเสี่ยง"""
    return (
