...
ตอบเป็นขั้นตอนชัดเจน แยกเป็นหัวข้อย่อยโดยใช้ emoji และเลขลำดับ:

🔍 สาเหตุ/ปัญหา:
(อธิบายสาเหตุหรือปัญหาสั้นๆ 1-2 ประโยค)
...
2. ชื่อสินค้าทางเลือก (ถ้ามี)
   • อัตราใช้: ...

📝 วิธีการใช้:
(อธิบายขั้นตอนการใช้อย่างละเอียด)

⏰ ช่วงเวลาที่เหมาะสม:
(บอกช่วงเวลาที่ควรใช้)

💡 ข้อแนะนำเพิ่มเติม:
(คำแนะนำอื่นๆ หรือข้อควรระวัง)

⚠️ หลักการ:
- ใช้ emoji เป็นหัวข้อ (🔍💊📝⏰💡⚠️) แทน markdown
- แยกบรรทัดให้ชัดเจน อ่านง่าย
- ใช้ • สำหรับรายละเอียดย่อย
- ตอบเฉพาะหัวข้อที่เกี่ยวข้องกับคำถาม (ไม่ต้องใส่ทุกหัวข้อ)
...
📋 รูปแบบการตอบ (สำคัญมาก!) - Q&A Vector Search:
- ตอบเป็นขั้นตอน แยกหัวข้อชัดเจนด้วย emoji (🔍💊📝⏰💡⚠️)
- ใช้เลขลำดับ 1. 2. 3. สำหรับรายการสินค้า
- ใช้ • สำหรับรายละเอียดย่อย (อัตราใช้, วิธีใช้)
- แยกบรรทัดให้อ่านง่าย
- ห้ามใช้ ** หรือ ## (ใช้ emoji แทน)
- ถ้าคำถามไม่ชัดเจน ให้ถามกลับสั้นๆ"""},
...
ตอบเป็นขั้นตอนชัดเจน แยกเป็นหัวข้อย่อยโดยใช้ emoji:
...
⚠️ หลักการ:
- ใช้ emoji เป็นหัวข้อ แทน markdown
- แยกบรรทัดให้ชัดเจน อ่านง่าย
- ใช้ • สำหรับรายละเอียดย่อย
...
💡 ข้อแนะนำ:
(คำแนะนำหรือแหล่งข้อมูลเพิ่มเติม เช่น กรมวิชาการเกษตร)

⚠️ หลักการ:
- ใช้ emoji เป็นหัวข้อ แทน markdown
- แยกบรรทัดให้ชัดเจน
- ตอบเฉพาะหัวข้อที่เกี่ยวข้อง
- ถ้าคำถามไม่ชัดเจน ให้ถามกลับสั้นๆ
...
📋 รูปแบบการตอบ (สำคัญมาก!) - Agriculture Question:
- ตอบเป็นขั้นตอน แยกหัวข้อชัดเจนด้วย emoji (🔍🌡️💊📝💡⚠️)
- ใช้เลขลำดับ 1. 2. 3. สำหรับรายการสินค้า
- ใช้ • สำหรับรายละเอียดย่อย (อัตราใช้, วิธีใช้)
- แยกบรรทัดให้อ่านง่าย
- ห้ามใช้ ** หรือ ## (ใช้ emoji แทน)
...
ตอบเป็นขั้นตอนชัดเจน ใช้ emoji เป็นหัวข้อ:

💊 ผลิตภัณฑ์: ชื่อสินค้า
...
📋 รูปแบบการตอบ:
- ตอบเป็นขั้นตอน แยกหัวข้อด้วย emoji (💊📝💧⏰⚠️)
