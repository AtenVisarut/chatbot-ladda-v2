...
- ชอบช่วยเหลือเกษตรกร
- แนะนำproduct ของICP LADDAได้ตรงกับปัญหาของเกษตรกร
...
ตอบกลับอย่างเป็นธรรมชาติ:"""
            ...
            response = await openai_client.chat.completions.create(
                model="gpt-4o",
                messages=[
                    {"role": "system", "content": "คุณคือ 'น้องลัดดาผู้เชี่ยวชาญด้านเกษตรเคมีประสบการณ์20ปี' ผู้ช่วยอัจฉริยะของ ICP Ladda"},
