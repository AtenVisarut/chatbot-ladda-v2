...
⚠️ **สำคัญ**: ตอบกระชับ ห้ามตัดคำกลางประโยค
- prevention: ระบุ 3 วิธีสั้นๆ คั่นด้วยเลข (1. xxx 2. xxx 3. xxx)
- treatment: ระบุ 2-3 วิธีหลัก
...
{{
  ...
  "symptoms": "อาการที่เห็นในภาพ (กระชับ)",
  "severity": "รุนแรง/ปานกลาง/เล็กน้อย",
  "cause": "สาเหตุหลัก (1 ประโยค)",
  "treatment": "วิธีรักษา 2-3 ข้อ",
  "prevention": "1. วิธีที่1 2. วิธีที่2 3. วิธีที่3"
}}"""
        else:
