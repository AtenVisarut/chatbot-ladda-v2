    ...
    try:
        ...
        if knowledge_docs:
            ...
            for idx, doc in enumerate(knowledge_docs[:5], 1):
                ...
                chemical_name = doc.get('chemical_name', '')  # สารสำคัญ
                ...
                if product_name:
                    ...
                    if chemical_name:
                        knowledge_context += f"\n   ชื่อสินค้า: {product_name} (สารสำคัญ: {chemical_name})"
                    else:
...
5. ปิดท้าย:
   ...
   - ถ้ายังไม่บอก → ถามว่า "ถ้าบอกขนาดถังพ่น น้องลัดดาช่วยคำนวณอัตราให้ได้ค่ะ"
...
5. ปิดท้าย:
   - ถ้าผู้ใช้บอกขนาดถังหรือพื้นที่มาแล้ว → คำนวณอัตราให้เลย ไม่ต้องถามซ้ำ
   - ถ้ายังไม่บอก → ถามว่า "บอกน้องลัดดาหน่อยค่ะ ใช้ถังพ่นกี่ลิตร น้องลัดดาคำนวณอัตราต่อถังให้เป๊ะๆ ได้เลยค่ะ"
...
- ตัวอย่าง: อัตรา 30 ซีซี/น้ำ 20 ลิตร + ถัง 50 ลิตร → 30 x (50/20) = 75 ซีซี
- ตัวอย่าง: อัตรา 50 ซีซี/ไร่ + 10 ไร่ → 50 x 10 = 500 ซีซี
...
async def handle_natural_conversation(user_id: str, message: str) -> str:
    ...
    try:
        ...
        if is_agri_q or is_prod_q or is_fert_q:
            logger.info(f"🔍 Routing to Q&A (agri={is_agri_q}, product={is_prod_q}, fertilizer={is_fert_q})")
