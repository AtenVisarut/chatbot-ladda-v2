...
WELCOME_MESSAGE = (
    ...
    "สอบถามน้องลัดดาเรื่องสินค้าของ ICP ลัดดาได้เลยนะคะ เช่น:\n\n"
    "🐛 \"เพลี้ยไฟทุเรียนใช้สารอะไรดี\"\n"
    "🍄 \"ข้าวใบจุดสีน้ำตาล มียาตัวไหน\"\n"
    "🌿 \"ยาฆ่าหญ้าในข้าวโพด แนะนำหน่อย\"\n"
    "💧 \"ปุ๋ยบำรุงทุเรียนช่วงออกดอก\"\n"
    "📦 \"อาร์ดอนใช้กับพืชอะไรได้บ้าง\"\n\n"
